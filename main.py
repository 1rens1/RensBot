...
async def help(ctx, message=None):
    ...
    embed.add_field(name="!random / !r", value="Sends a random number", inline=True)
    embed.add_field(name="!m8ball / !m8", value="Got a question?\nAsk the magic 8 ball!", inline=True)
    embed.add_field(name="!ping", value="Shows the bot latency", inline=True)
